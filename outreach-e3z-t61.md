...
## 1. 开发信（发给潜在客户 / B2B 买家 / 自动化公司）

> **Subject:** OMRON E3Z-T61 Through-beam Sensor 15m — In stock, ready to ship
>
> Hi there,
>
> I'm reaching out from **Tuochen Trade (抚州市临川区拓辰贸易商行)**, a supplier of brand-new industrial automation components.
>
> We currently have **OMRON E3Z-T61 through-beam photoelectric sensors** in stock:
>
> - **Model:** E3Z-T61 (emitter + receiver pair)
...
>
> If you're interested, I'd be happy to send a formal quotation, spec sheet, or arrange a sample order. Feel free to reply here or reach me on WhatsApp.
>
> Best regards,
> *
> 熊诚君 · Tuochen Trade
> WhatsApp: +86 185 8742 3364
> Payment: Alipay / bank transfer / (万里汇 regional transfer)
> Shipping: Air/Express from Guangzhou, worldwide

---

## 2. WhatsApp 简短询价（拉近关系，一问一答）
...
- **Shipping:** Express (DHL/FedEx/UPS) or air freight, from Guangzhou
- **Warranty:** Replacement if damaged on arrival (within 30 days)

---

## 4. 话术小贴士

- **别一上来就贴价格**，先问对方是不是采购/做哪类设备，再报产品。
- **强调 original + brand new**（国外买家最怕仿品）。
- **15m 是 E3Z-T61 的核心卖点**，普通 E3Z-T61 对射型感应距离就是这个，遇到需求长距离的客户优先推。
- 对方问是不是双数（一对），确认**就是成对卖**（发射+接收）。
